...
function StudentView({user,logout}:{user:any;logout:()=>void}){
  ...
  const mis=[{id:"grades",icon:"test",label:"성적표"},{id:"notice",icon:"bell",label:"공지사항"},{id:"myexam",icon:"folder",label:"시험 결과"},{id:"settings",icon:"settings",label:"설정"}];
...
export default function Home(){
  ...
  const mi=[{id:"classes",icon:"folder",label:"반 / 시험"},{id:"students",icon:"users",label:"학생 관리"},{id:"exams",icon:"test",label:"시험 성적"},{id:"notices",icon:"bell",label:"공지사항"},{id:"site",icon:"upload",label:"로그인 화면"},{id:"settings",icon:"settings",label:"설정"}];
