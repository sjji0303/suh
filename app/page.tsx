...
function StudentView({user,logout}:{user:any;logout:()=>void}){
  ...
  const[examForm,setExamForm]=useState({exam_type:"모의고사",exam_name:"",subject:"",score:"",total:"",grade:"",memo:"",exam_date:"",q1:"",q2:"",q3:"",
  ...
  return(<div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-[#6c63ff]/5 flex">
    ...
    <main className="flex-1 lg:ml-56 pt-14 lg:pt-0"><div className="max-w-3xl mx-auto p-4 sm:p-5 lg:p-8">
      ...
      {tab==="shorts"&&<div>
        <div className="mb-4"><h2 className="text-xl font-bold">🥩 서서갈비</h2><p className="text-xs text-slate-400 mt-1">서정인 수학 유튜브 쇼츠</p></div>
        <div className="relative rounded-2xl overflow-hidden shadow-lg border border-slate-100/50 bg-black" style={{paddingBottom:"177.78%"}}>
          <iframe src="https://www.youtube.com/@agreesuh/shorts" className="absolute inset-0 w-full h-full" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen style={{border:"none"}}/>
        </div>
        <div className="mt-4 text-center"><a href="https://www.youtube.com/@agreesuh/shorts" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-gradient-to-r from-red-500 to-red-600 text-white px-6 py-2.5 rounded-xl text-sm font-semibold shadow-md shadow-red-500/20 hover:shadow-lg transition-all"><svg viewBox="0 0 24 24" width="18" height="18" fill="white"><path d="M23.498 6.186a2.832 2.832 0 00-1.991-2.006C19.691 3.592 12 3.592 12 3.592s-7.691 0-9.507.588A2.832 2.832 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a2.832 2.832 0 001.991 2.006C4.309 20.408 12 20.408 12 20.408s7.691 0 9.507-.588a2.832 2.832 0 001.991-2.006C24 15.93 24 12 24 12s0-3.93-.502-5.814z"/><path d="M9.545 15.568V8.432L15.818 12z" fill="#282828"/></svg>유튜브에서 보기</a></div>
      </div>}
